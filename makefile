...
all: rk_test_05 sc_interface_04 bc_test_04 sc_interface_03 mt_test_03 sc_test_02 
...
clean:
		...
		make clean -C lab_04
		make clean -C lab_05
		rm -f *.o sc_test_02 mt_test_03 sc_interface_03 sc_interface_04 bc_test_04 big_digits.bin test_sc_memorySave.bin rk_test_05
